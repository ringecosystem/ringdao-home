...
const EmpoweringChains = () => {
  return (
    <div className="px-[20px] relative pb-[50px] sm:px-[100px] border-[1px] border-[#585858] border-t-[transparent]">
      <h3 className="font-[300] text-[40px] leading-[50.72px] text-white sm:leading-[90px]">
        EMPOWERING CHAINS TO COMMUNICATE
        <span className="font-[700] text-[40px] leading-[50.72px] text-white italic block sm:leading-[90px]">
